...
public class Plastic2Glitch : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Time.time >= glitchStartTime1 && Time.time < glitchStartTime1 + glitchDuration && !glitching) {
            ...
            this.objectRenderer.material = (Material)Resources.Load("Materials/Plastic (2) 1", typeof(Material));
            glitching = true;
        }
        if (Time.time >= glitchStartTime1 + glitchDuration && glitching) {
            this.objectRenderer.material = (Material)Resources.Load("Materials/Plastic (2)", typeof(Material));
            glitching = false;
        }
    }
}
